...
void test()
{
  ...
  assert(!read_u64s(actual_buffer, 30, actual_u64s, 3, 7), "read_u64s invalid_1");

  const uint64_t expected_u64s[] = {0x71510A0492748A78, 0x62FA97A2E980CC87, 0xE017D981980DECA7};
  assert_u64s(expected_u64s, actual_u64s, 3, "read_u64s invalid_1 u64s");
  ...
  assert_u8s(expected_buffer, actual_buffer, 30, "read_u64s invalid_1 buffer");
}
