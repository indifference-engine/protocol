...
/**
 * Attempts to write one or more signed 64-bit integers to a buffer.
 * @param s64s The signed 64-bit integers to write.
 * @param quantity The number of signed 64-bit integers to write.
 * @param offset The offset within the buffer from which to write the signed
 *               64-bit integers.
 * @param buffer The buffer to which to write the signed 64-bit integers.
