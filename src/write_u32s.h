...
/**
 * Attempts to write one or more unsigned 32-bit integers to a buffer.
 * @param u32s The unsigned 32-bit integers to write.
 * @param quantity The number of unsigned 32-bit integers to write.
